...
| 附录 | [源码地图](appendix-source-map.md) | 从 Python 装配面追到 Runtime 权威实现 |

## 配套材料

- [十个可运行实验](../../../academy/README.md)
- [教材正文计划与验证记录](../2026-08-19-senza-academy-textbook-plan.md)
- [学习版 PPT 与预览](../assets/README.md)
- [架构导读](../architecture.md)
- [能力边界](../capability-boundaries.md)
- [课程实施计划](../2026-08-19-senza-academy-ai-agent-book-plan.md)
