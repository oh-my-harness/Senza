...
def create_status_panel_plugin() -> Plugin: ...
...
def create_injection_filter_plugin(patterns: Optional[list[str]] = None) -> Plugin: ...
def create_source_tag_plugin(entries: list[dict]) -> Plugin: ...
